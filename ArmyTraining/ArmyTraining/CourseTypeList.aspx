<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseTypeList.aspx.cs"
    Inherits="ArmyTraining.CourseTypeList" MasterPageFile="~/Main.Master" %>

<asp:Content ID="header" ContentPlaceHolderID="head" runat="server">
    Course types</asp:Content>
<asp:Content ContentPlaceHolderID="PageContent" runat="server" ID="content">
    <script language="javascript" type="text/javascript">
        detailUrl = "CourseTypeDetail.aspx";
        detailHeight = 120;
        detailWidth = 380;
    </script>
    <div>
        <div style="height: 530px; overflow: auto; border: solid 1px #777777">
                ...
                <AlternatingItemTemplate>
                    <tr style="background-color: #DDDDDD">
                        <td class="Input ItemPaddingStyle" style="padding-left: 10px; border-bottom: solid 1px #777777">
                            <%#((ArmyTraining.Model.CourseType)Container.DataItem).Name%>
                        </td>
            ...
            <div id="spnEmptyRow" runat="server" class="ItemStyle" style="padding-left: 10px;
                ...
                There are no course type in the system.</div>
        </div>
