<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingBackgroundDetail.aspx.cs"
    Inherits="ArmyTraining.TrainingBackgroundDetail" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function validateData() {
            ...
            if (name == "") {
                errorMsg += "Please enter training background name\n";
            }
            if (errorMsg != "") {
                alert(errorMsg);
                return false;
