<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseList.aspx.cs" Inherits="ArmyTraining.CourseList"
...
<asp:Content ID="content" runat="server" ContentPlaceHolderID="PageContent">    
    ...
    <div style="border: SOLID 1px #777777; padding: 5px 10px;">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                ...
                <td style="width: 30%">
                    <asp:DropDownList runat="server" ID="drpCourseTypes" DataTextField="Name" DataValueField="Id" />
                </td>
                <td style="width: 15%">
                    Training background
                </td>
                <td style="width: 30%">
                    <asp:DropDownList runat="server" ID="drpTrainingBkg" DataTextField="Name" DataValueField="Id" />
                </td>
                <td style="width: 15%">
                    Keywords (name)
                </td>
    ...
    <div style="height: 490px; overflow: auto; border: solid 1px #777777; margin-top: 3px;">
            ...
            <AlternatingItemTemplate>
                <tr style="background-color: #DDDDDD">
                    <td class="Input ItemPaddingStyle" style="border-bottom: solid 1px #777777; padding-left: 10px">
                        <%#((ArmyTraining.Model.Course)Container.DataItem).Name%>
                    </td>
                    <td style="border-bottom: solid 1px #777777;">
                        <div class="Input" runat="server" id="dvCourseType">
                        </div>
                    </td>
                    <td class="ItemPaddingStyle" style="border-bottom: solid 1px #777777;">
                        <%#((ArmyTraining.Model.Course)Container.DataItem).TrainingBkg.Name%>
                    </td>
        ...
        <div id="spnEmptyRow" runat="server" class="ItemStyle" style="padding-left: 10px;
            ...
            There are no course in the system.</div>
    ...
    <div style="padding-top: 5px;">
        <asp:Button runat="server" Text="Add" Width="70" OnClick="ItemEdited" OnClientClick="return OpenDetail(0)" />
    </div>
</asp:Content>
