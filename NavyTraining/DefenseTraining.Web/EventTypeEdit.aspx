...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            _eventType = getEventType(queryString);
        ...
        function getEventType(queryString) {
            var eventType = new Object();
            var parms = queryString.split('&');
            eventType.Id = parms[0].substring(parms[0].indexOf("=") + 1);
            eventType.Name = parms[1].substring(parms[1].indexOf("=") + 1);
            return eventType;
        }
    </script>
</head>
