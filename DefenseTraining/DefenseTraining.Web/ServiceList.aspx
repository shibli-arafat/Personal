<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceList.aspx.cs" Inherits="DefenseTraining.Web.ServiceList"
    ...
    <script language="javascript" type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.IsSuccessful) {
                        _services = data.d.Data;
                        $("#dataContainer > tbody").empty();
                        $("#tmplData").tmpl(_services).appendTo("#dataContainer > tbody");
                    }
                    else {
        ...
        function openWindow(id) {
            ...
            $.window({
                showModal: true,
                title: wTitle,
                url: "ServiceEdit.aspx?Id=" + id + "&Name=" + decoration.Name,
                height: 170,
                width: 350,
                resizable: false,
                maximizable: false,
        ...
        function deleteData(id) {
            if (confirm("Are you sure you want to delete this record?") == true) {
                $.ajax({
                    type: "POST",
                    url: "ServiceList.aspx/DeleteService",
