<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArmServiceList.aspx.cs"
    Inherits="ArmyTraining.ArmServiceList" MasterPageFile="~/Main.Master" %>

<asp:Content ID="header" ContentPlaceHolderID="head" runat="server">
    Arm/Services</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="PageContent" ID="content">
    <script language="javascript" type="text/javascript">
        detailUrl = "ArmServiceDetail.aspx";
        detailHeight = 120;
        detailWidth = 380;
    </script>
    <div>
        <div style="height: 530px; overflow: auto; border: solid 1px #777777">
                ...
                <AlternatingItemTemplate>
                    <tr style="background-color: #DDDDDD">
                        <td class="Input ItemPaddingStyle" style="padding-left: 10px; border-bottom: solid 1px #777777">
                            <%#((ArmyTraining.Model.Service)Container.DataItem).Name%>
                        </td>
            ...
            <div id="spnEmptyRow" runat="server" class="ItemStyle" style="padding-left: 10px;
                ...
                There are no service in the system.</div>
        </div>
        <div style="padding-top: 5px;">
            <asp:Button runat="server" Width="70" ID="btnAdd" OnClick="ItemEdited" OnClientClick="return OpenDetail(0)"
                Text="Add" />
        </div>
    </div>
</asp:Content>
