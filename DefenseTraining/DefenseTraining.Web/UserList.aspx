...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="content">
    <input id="hdnHasPermission" type="hidden" runat="server" value="" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function populateData() {
            $.ajax({
                ...
                data: JSON.stringify({ keyword: $("#txtKeyword").val(), roleId: parseInt($("#cmbRoles").val(), 10), rankId: parseInt($("#cmbRanks").val(), 10) }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    if (data.d.IsSuccessful) {
