<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TrainingBackgroundList.aspx.cs" Inherits="ArmyTraining.TrainingBackgroundList" %>
<asp:Content ID="header" ContentPlaceHolderID="head" runat="server">
    Decorations</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="PageContent" ID="content">
    <script language="javascript" type="text/javascript">
        detailUrl = "TrainingBackgroundDetail.aspx";
        detailHeight = 120;
        detailWidth = 380;
    </script>
    <div>
        <div style="height: 530px; overflow: auto; border: solid 1px #777777">
                ...
                <AlternatingItemTemplate>
                    <tr style="background-color: #DDDDDD">
                        <td class="Input ItemPaddingStyle" style="padding-left: 10px; border-bottom: solid 1px #777777">
                            <%#((ArmyTraining.Model.TrainingBackground)Container.DataItem).Name%>
                        </td>
            ...
            <div id="spnEmptyRow" runat="server" class="ItemStyle" style="padding-left: 10px;
                ...
                There are no training background in the system.</div>
        </div>
